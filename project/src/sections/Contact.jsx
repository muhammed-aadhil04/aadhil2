...
const contactInfo =[
    {
        icon: Mail,
        label: "Email",
        value: "muhammadaadhil2511@gmail.com",
        ...
        <div className="container mx-auto px-6 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <p className="text-muted-foreground animate-fade-in animation-delay-200">
                    have a project in mind? I'd love to hear about it. send me amessage
            ...
            <div className="space-y-6 animate-fade-in animation-delay-400">
                <div className="glass rounded-3xl p-8">
                    ...
                    <div className="space-y-4">
                        {contactInfo.map((item, i)=>(
                            ...
                            key={i}
                            href={item.href}
                            className="flex items-center gap-4 p-4 rounded-xl hover:bg-surface transition-colrs"
                            >
                ...
                <p className="text-muted-foreground text-sm">
                    ...
                    whether you need a full-time engineer or a freelance consltant,
                    let's talk!
                </p>
                </div>
            </div>
